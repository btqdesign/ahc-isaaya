			...
			<div class="modal-content">
				...
				<div style="padding: 0px;" class="modal-body">
					<?php if (isMobile == false): ?>
						...
						<?php endif; ?>
						<?php if ($language == 'es'): ?>
						<a href="https://www.isaayahotelboutique.mx/es/5-razones-para-reservar-con-nosotros/"><img src="<?php echo plugins_url( 'imagenes/body_mob.jpg', __FILE__ ); ?>" alt="Top 5 razones por las que conviene reservar."></a>
						<?php else: ?>
						<a href="https://www.isaayahotelboutique.mx/en/5-reasons-to-book-with-us/"><img src="<?php echo plugins_url( 'imagenes/body_mob_en.jpg', __FILE__ ); ?>" alt="Top 5 reasons why you should book."></a>
						<?php endif; ?>
					...
					<?php else: ?>
						...
						<?php endif; ?>
						<?php if ($language == 'es'): ?>
						<a href="https://www.isaayahotelboutique.mx/es/5-razones-para-reservar-con-nosotros/"><img src="<?php echo plugins_url( 'imagenes/body_web.jpg', __FILE__ ); ?>" alt="Top 5 razones por las que conviene reservar."></a>
						<?php else: ?>
						<a href="https://www.isaayahotelboutique.mx/en/5-reasons-to-book-with-us/"><img src="<?php echo plugins_url( 'imagenes/body_web_en.jpg', __FILE__ ); ?>" alt="Top 5 reasons why you should book."></a>
						<?php endif; ?>
