...
add_filter('final_output', function($output) {
    $patt = array(
        ...
        //,'/("|\')(https?)(:)(\\\\\/\\\\\/)/'
        //,'/(,\s*("|\')?)(https?)(:)(\/\/)/'
        '/(("|\')https?:\/\/((isaaya\.idevol\.net)|(www\.isaayahotelboutique\.mx))\/[a-zA-Z0-9\._\/-]*\.(css|js))(\?(ver|version)=[a-zA-Z0-9%_.-]{1,8})("|\')/'
    );
    $repl = array(
        //'${1}${7}'
        //,'${1}${5}'
...
add_filter('wp_redirect', function($output) {
	$output = str_replace('http://isaaya.idevol.net', 'https://isaaya.idevol.net', $output);
	$output = str_replace('http://www.isaayahotelboutique.mx', 'https://www.isaayahotelboutique.mx', $output);
